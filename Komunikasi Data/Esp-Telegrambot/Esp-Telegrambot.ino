...
TBMessage tMessage;
String token = "5731738203:AAEgyV3kTLDFbNpvW0_K6ZxTB3fOiHnhHk0";
CTBot myBot;
...
void loop()
{
    ...
    if (myBot.getNewMessage(tMessage))
    {
        ...
        if (tMessage.messageType == CTBotMessageText)
        {
            ...
            {
                String reply = "";
                reply += "Hi, Welcome "+ tMessage.sender.firstName + " to Kelompok 9 Bot\n";
                reply += "Gunakan List Command dibawah ini : \n";
                reply += "Scan WIFI : /scan \n";
